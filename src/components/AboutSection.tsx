        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <motion.div
            ...
            <div className="space-y-4 font-body text-base leading-relaxed text-muted-foreground">
              <p>I'm Prakash S — Sr UX Designer/Analyst with 12+ years of experience building products that make a real difference. I've had the privilege of working across Communications, Media, Technology, Retail, and Hospitality, partnering with everyone from C-suite stakeholders to frontline users.
