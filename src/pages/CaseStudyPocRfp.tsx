...
}: {number: string;icon: React.ReactNode;domain: string;overview: string;problems: string[];wireframes: {src: string;alt: string;}[];solutions: string | string[];benefits: string[];}) =>
<motion.div
